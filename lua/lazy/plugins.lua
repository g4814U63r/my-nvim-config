...
return {
...

	{
		...
		config = function()
			...
			dapui.setup({
				controls = {
					element = "repl", -- Changed 'compact' to 'repl' as 'compact' can sometimes cause nil errors in older versions
					icons = {
						pause = "⏸",
						play = "▶",
						step_into = "⏎",
			...
			require("mason-nvim-dap").setup({
				...
				handlers = {}, -- Let mason-nvim-dap handle the basics
			})

			-- 3. Define PHP Adapter manually (Mason path)
			dap.adapters.php = {
				type = "executable",
				command = "node",
